...
package cn.metaq.example.google;
...
public class Speedtest {
  ...
  public static void main(String args[]) throws IOException {
    String text1 = readFile("/Users/zantang/IdeaProjects/metaq-examples/metaq-text-iceblue-example/Speedtest1.txt");
    String text2 = readFile("/Users/zantang/IdeaProjects/metaq-examples/metaq-text-iceblue-example/Speedtest2.txt");
